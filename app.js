...
const PUZZLES = [
  ...
  },
  {
    ...
    category: "Advanced",
    goal: "White to move: Deliver the Arabian Mate — trap the King in the corner!",
    fen: "7k/5Rpp/8/8/8/8/6PP/6K1 w - - 0 1",
    solution: ["f7f8"],
    hint: "Slide your Rook from f7 to f8 — the Black King on h8 is completely trapped by its own pawns on g7 and h7!"
  }
];
