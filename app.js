...
const PUZZLES = [
  ...
  // ==================== INTERMEDIATE (Tactical Forks, Pins, Discoveries) ====================
  {
    ...
    solution: ["e4f6"],
    hint: "Jump your Knight to f6 to check the King and attack the d5 Queen at the same time!"
  },
  {
    id: "puzzle_10",
  ...
  },
  {
    ...
    solution: ["d1d7"],
    hint: "Black left the Bishop on d7 undefended. Snatch it with your Queen!"
  },
  {
    id: "puzzle_12",
    title: "Queen Infiltration Mate in 2",
    category: "Intermediate",
    goal: "White to move: Deliver checkmate in 2 moves!",
    fen: "r1b2rk1/pp3ppp/2n1p3/3p4/8/2N2Q2/PPP2PPP/R3KB1R w KQ - 0 1",
    solution: ["f3f7", "g8h8", "f7f8"],
    hint: "Take the f7 pawn with check, then follow through with Qf8# after the King flees!"
  },
  {
    id: "puzzle_13",
  ...
  {
    id: "puzzle_14",
    title: "Bishop Interposition Defense",
    category: "Intermediate",
    goal: "White to move: Block the check and save your King!",
    fen: "4k3/8/8/8/8/8/4B3/4K1q1 w - - 0 1",
    solution: ["e2f1"],
    hint: "Block the Black Queen's check by dropping your Bishop back to f1!"
  },
  {
    id: "puzzle_15",
  ...
  {
    id: "puzzle_17",
    title: "Bishop Diagonal Strike",
    category: "Advanced",
    goal: "White to move: Exploit Black's weak queenside pawns!",
    fen: "2kr4/ppp2p2/4b3/8/8/8/PPP2B2/2K1RB2 w - - 0 1",
    solution: ["f2a7"],
    hint: "Slice through Black's pawn chain by capturing the pawn on a7 with your Bishop!"
  },
  {
    id: "puzzle_18",
